...
def get_Quiz(correctness,prev_questions):
  ...
  if correctness == 0:
     ...
     if (number_query % 2) == 0:
         if number_query<=10:
           data = f'Write a (only one) new question about general culture with {number_options} choices/answers specified with letters after the question, specificy the correct answer at the end of the text \n'+'Please do not repeat any of these following questions: '+ prev_question_string+ '\n'
         else:
           data = f'Write a (only one) new, easy, and random question with  {number_options} choices/answers, specify the choices with letters after the question, and specify the correct answer at the end of the text \n'+'Please do not repeat any of these following questions: '+ prev_question_string+ '\n'
     else:
           data = f'Write a (only one) new question about contemporary culture with {number_options} choices/answers specified with letters after the question, specificy the correct answer at the end of the text \n'+'Please do not repeat any of these following questions: '+ prev_question_string+ '\n'
  else:
     number_query=random.randint(0,20)
     if (number_query % 2) == 0:
       if number_query<=10:
         data =  f'Write a (only one) new hard/difficult question about any specific topic with {number_options} choices/answers specified with letters after the question, specificy the correct answer at the end of the text \n'+'Please do not repeat any of these following questions: '+ prev_question_string+ '\n'
       else:
         data = f'Write a (only one) new hard/difficult random question {number_options} choices/answers about any specific topic, specify the choices with letters after the question, and specify the correct answer at the end of the text \n'+'Please do not repeat any of these following questions: '+ prev_question_string+ '\n'
     else:
         data =  f'Write a (only one) VERY HARD! new question about any specific topic with {number_options} choices/answers specified with letters after the question, specificy the correct answer at the end of the text \n'+'Please do not repeat any of these following questions: '+ prev_question_string+ '\n'
...
def get_response(answer,string_quiz,ccount,correct_count,len_quiz,string_prev):
   ...
   if answer.lower()=='yes' or answer.lower()=='y' or answer.lower()=='ok':
      ...
      return('If you want to do another quiz please close and open the chatbox, or reply yes! \n End of the Quiz!\n',correct_count)
   else:
